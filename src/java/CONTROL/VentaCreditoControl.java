 ...
 */
public class VentaCreditoControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        VentaCreditoDAO ventaCreditoDao = auditorFac.crearObjetoVentaCredito();
        ventaCreditoDao.crearConexion(cn.getConexion());
        ...
        switch (Integer.parseInt(accion)) {
            case 1:
                try {
                    ...
                    error = ventaCreditoDao.insertar(ventaCreditoDto);
                } catch (Exception e) {
                    error = "Error : " + e.getMessage();
                    System.out.println("VentaCreditoControl.java : " + error);
                }
                break;
            case 2:
                try {
                    ...
                    error = ventaCreditoDao.modificar(ventaCreditoDto);
                } catch (Exception e) {
                    error = "Error : " + e.getMessage();
                    System.out.println("VentaCreditoControl.java : " + error);
                }
            ...
            case 3:
                ...
                try {
                    error = ventaCreditoDao.eliminar(Integer.parseInt(id));
                } catch (Exception e) {
                    error = "Error : " + e.getMessage();
                    System.out.println("VentaCreditoControl.java : " + error);
                }
