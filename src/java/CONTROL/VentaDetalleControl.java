...
import CONTROL.factoryControlObjetos;
 ...
 */
public class VentaDetalleControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        VentaDetalleDAO ventaDetalleDao = auditorFac.crearObjetoVentaDetalle();
        ...
        switch (Integer.parseInt(accion)) {
            case 1:
                try {
                    ...
                    System.out.println("VentaDetalleControl.java : " + error);
                }
                break;
            case 2:
                try {
