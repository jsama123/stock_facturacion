 ...
 */
public class TraspasoAnulacionControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            System.out.println("ANULANDO TRASPASO");
            cn.getConexion().setAutoCommit(false);

            traspasoDto.setId(Integer.parseInt(id));
            traspasoDto.setUsu_modi(usuario);

            error = traspasoDao.anular(traspasoDto);
            System.out.println("TRASPASO ANULADO");
            while (rs.next()) {
                ...
                error = stockDao.anulacionStockActualizarTraspasoOrigen(stockDto);
                ...
                if (rs1.next()) {
                    ...
                    stockDto.setExistencia(Double.valueOf(rs.getString(4)));
                    stockDto.setUsu_modi(usuario);
                    error = stockDao.anulacionStockActualizarTraspasoDestino(stockDto);
            ...
            System.out.print("TraspasoAnulacionControl" + " - " + error);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(TraspasoAnulacionControl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
