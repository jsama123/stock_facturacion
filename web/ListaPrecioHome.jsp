...
<html>
    ...
    <body>
        ...
        <table id="tblListaPrecios" style="font-size: small;" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
            ...
            <tbody id="cuerpoListaPrecios" style="">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header table-primary">
                        <h5 class="modal-title" id="modalFormTittle">Agregar un nuevo Registro / Descuentos</h5>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label>Descripción : <span style="color: red; font-weight: bold">*</span></label>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label>Porcentaje : <span style="color: red; font-weight: bold">*</span> </label>
                                    <input type="text" id="txtPorcentaje" name="camposForm" class="form-control" >
                                </div>
                            </div>
                        </div>
                        <div class="row">
    ...
    <script src="js-sistema/listaPrecio.js"></script>
</html>
