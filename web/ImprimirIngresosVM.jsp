...
<html>
    ...
    <body>
        <h4>Generar Informe Ingresos / Ventas Manuales</h4><hr>
        ...
        <button class="btn btn-sm btn-primary" onclick="imprimirReporteExcel()">Descargar Excel</button>
        ...
        <script type="text/javascript">
            ...
            function imprimirReporteExcel(){
                ...
                window.location.href = "ReporteIngresosSETVentaManual.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val();
            }
        </script>
    </body>
</html>
