...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <table id="tblVentas" style="font-size: small;" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                <div class="modal-dialog modal-lg" style="font-size: small;" role="document">
                    <div class="modal-content">
                        <div class="modal-header table-primary">
                            <h5 class="modal-title" id="modalFormTittle">Agregar un nuevo Registro / Venta</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col" id="divColCuotas" style="display: none">
                                    <div class="form-group">
                                        ...
                                        <select id="cmbCantCuotaVentas" class="form-control form-control-sm">
                                        </select>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-dialog modal-lg" style="font-size: small;" role="document">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: powderblue">
                            <h5 class="modal-title" id="modalFormTittle">Detalles de Ventas</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body" style="height: 500px; overflow: scroll;">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label>Costo de Venta a Aplicar : </label>
                                        <select id="cmbCostoVenta" name="camposFormDetalle" class="form-control form-control-sm"></select>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>Existencia Correspondiente : </label>
                                        <select id="cmbExisArticulo" name="camposFormDetalle" class="form-control form-control-sm"></select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <table id="tblArticuloVentas" style="font-size: small;" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                <thead class="table-primary">
                                <th>ARTICULO</th>
                                <th>CANTIDAD</th>
                                <th>DESC. APLICADO</th>
                                ...
                                <tbody id="cuerpoArticuloVentass"></tbody>
                                <tfoot>
                                    <tr>
                            ...
                            <button class="btn btn-sm btn-info" onclick="if (parseInt($('#txtPagoVenta').val().replace(/[^a-z0-9\s]/gi, '')) < parseInt(retornarTotalVenta())) {
                                        console.log(parseInt($('#txtPagoVenta').val().replace(/[^a-z0-9\s]/gi, ''))+'---'+parseInt(retornarTotalVenta()));
