...
<html>
    ...
    <body>
        <h4>Generar Informe Egresos por Fecha</h4><hr>
        ...
        <button class="btn btn-sm btn-primary" onclick="imprimirReporteExcel()">Descargar en Excel</button>
        ...
        <script type="text/javascript">
            ...
            function imprimirReporteExcel(){
                ...
                window.location.href = "ReporteEgresosSET.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val();
            }
        </script>
    </body>
</html>
