...
<%    Conexion cn = new Conexion();
    ...
    //cn.getConexion();
    String id_venta_manual = request.getParameter("id_venta_manual");
    String loginUsuario = (String) sesion.getAttribute("loginUsuario");

    File archivo = new File(application.getRealPath("reportes/rpt_venta_manual.jasper"));
    Map parametros = new HashMap();

    parametros.put("id_venta_manual", id_venta_manual);
