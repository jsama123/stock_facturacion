...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <table id="tblGrupos" style="font-size: small;" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalFormTittle">Agregar un nuevo Registro / Grupo</h5>
    ...
    <script src="js-sistema/grupo.js"></script>
</html>
