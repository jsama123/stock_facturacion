...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <table id="tblDepositos" style="font-size: small;" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                <tbody id="cuerpoDepositos" style="">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header table-primary">
                            <h5 class="modal-title" id="modalFormTittle">Agregar un nuevo Registro / Deposito</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select id="cmbSucursal" class="form-control" style="font-size: small"></select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label>Deposito Comercial <input type="checkbox" id="chkDepComer"> </label>
                                    </div>
                                </div>
                                <div class="col">
                                </div>
    ...
    <script src="js-sistema/deposito.js"></script>
</html>
