...
<html>
    ...
    <body>
        ...
        <table id="tblProveedors" style="font-size: small;" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
            ...
            <tbody id="cuerpoProveedors" style="">
            ...
            <div class="modal-dialog modal-lg" style="font-size: small;" role="document">
                <div class="modal-content">
                    <div class="modal-header table-primary">
                        <h5 class="modal-title" id="modalFormTittle">Agregar un nuevo Registro / Proveedor</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label style="font-weight: bold; color: cadetblue">Los campos marcados con * son obligatorios</label>
                            </div>
                        </div>
                    </div>
    ...
    <script src="js-sistema/proveedor.js"></script>
</html>
