...
<html>
    <head>
        ...
        <title>Imprimir facturas consolidado por fecha</title>
    ...
    <body>
        <h4>Imprimir Facturas de Ventas Manuales Consolidado por Fecha</h4><hr>
        ...
        <script type="text/javascript">
            ...
            function imprimirReporte(){
                window.open("ReporteFacturasManualConsolidadoxFecha.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val(), "_blank");
            ...
            function imprimirReporteExcel(){
                ...
                window.location.href = "ReporteFacturasManualConsolidadoxFechaXLS.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val();
            }
        </script>
    </body>
</html>
