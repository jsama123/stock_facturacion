...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <table id="tblCajas" style="font-size: small;" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalFormTittle">Agregar un nuevo Registro / Caja</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label>Nro de Caja : <span style="color: red; font-weight: bold">*</span>  </label>
                                        <input type="text" id="txtNroCaja" class="form-control" size="30px">
                                    </div>
                                </div>
                            </div>
