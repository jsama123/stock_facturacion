...
<%    Conexion cn = new Conexion();
    ...
    //cn.getConexion();
    String id_arqueo = request.getParameter("id_arqueo");
    String loginUsuario = (String) sesion.getAttribute("loginUsuario");

    File archivo = new File(application.getRealPath("reportes/rpt_arqueo_caja.jasper"));
    Map parametros = new HashMap();

    parametros.put("id_arqueo_caja", id_arqueo);
