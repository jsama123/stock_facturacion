...
<html>
    ...
    <body>
        <h4>Imprimir Compras Consolidado de Articulos por Fecha</h4><hr>
        ...
        <script type="text/javascript">
            ...
            function imprimirReporte(){
                window.open("ReporteCompraArticuloxFecha.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val(), "_blank");
            ...
            function imprimirReporteExcel(){
                ...
                window.location.href = "ReporteCompraArticuloxFechaXLS.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val();
            }
        </script>
    </body>
</html>
