...
<html>
    ...
    <body>
        <h4>Imprimir Ventas Manuales / Consolidado de Articulos por Fecha</h4><hr>
        ...
        <script type="text/javascript">
            ...
            function imprimirReporte(){
                window.open("ReporteVentaManualArticuloxFecha.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val(), "_blank");
            ...
            function imprimirReporteExcel(){
                ...
                window.location.href = "ReporteVentaManualArticuloxFechaXLS.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val();
            }
        </script>
    </body>
</html>
