...
<html>
    ...
    <body>
        ...
        <div class="form-inline">
            <label>Imprimir Solo facturas en excel :</label>
            <input type="checkbox" id="chkFacImpr">
        </div>
        ...
        <script type="text/javascript">
            ...
            function imprimirReporte(){
                window.open("ReporteVentaxFecha.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val(), "_blank");
