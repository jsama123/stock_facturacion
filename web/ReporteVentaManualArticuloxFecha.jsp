...
<%    Conexion cn = new Conexion();
    ...
    File archivo = new File(application.getRealPath("reportes/rpt_venta_manual_consolidado_articulo.jasper"));
    Map parametros = new HashMap();

    parametros.put("fecha_desde", fecha_inicio);
    parametros.put("fecha_hasta", fecha_fin);
