...
<html>
    ...
    <body>
        <h4>Imprimir Existencia en Guaranies de Articulos por Deposito</h4><hr>
        ...
        <script type="text/javascript">
            ...
            function imprimirReporte(){
                window.open("ReporteArticuloGsxDeposito.jsp?id_deposito=" + $("#cmbDepositoImprm").val(), "_blank");
            ...
            function imprimirReporteExcel(){
                ...
                window.location.href = "ReporteExistenciaGsDepositoXLS.jsp?id_deposito=" + $("#cmbDepositoImprm").val();
            }
        </script>
    </body>
</html>
