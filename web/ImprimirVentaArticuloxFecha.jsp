...
<html>
    ...
    <body>
        <h4>Imprimir Ventas Consolidado de Articulos por Fecha</h4><hr>
        ...
        <script type="text/javascript">
            ...
            function imprimirReporte(){
                window.open("ReporteVentaArticuloxFecha.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val(), "_blank");
            ...
            function imprimirReporteExcel(){
                ...
                window.location.href = "ReporteVentaArticuloxFechaXLS.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val();
            }
        </script>
    </body>
</html>
