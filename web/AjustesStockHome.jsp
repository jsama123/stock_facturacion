...
<html>
    ...
    <body>
        ...
        <h4>Administrar Ajustes de Existencias</h4>
        <div class="container-fluid">
            ...
            <table id="tblAjustesStocks" style="font-size: small;" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                <tbody id="cuerpoAjustesStocks" style="">
                ...
                <div class="modal-dialog modal-lg" style="font-size: small;" role="document">
                    <div class="modal-content">
                        <div class="modal-header table-primary">
                            <h5 class="modal-title" id="modalFormTittle">Agregar un nuevo Registro / AjustesStock</h5>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="txtCantidadAjuste" name="camposForm" class="form-control">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label>Operacion :</label>
                                        <select id="cmbOperacion" class="form-control form-control-sm">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="camposForm" id="txtObsAjustes"></textarea>
                                    </div>
                                </div>
                                <div class="col">
                                </div>
    ...
    <script src="js-sistema/ajustesStock.js"></script>
</html>
