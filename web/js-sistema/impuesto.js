...
function accionProceso(opcion) {
    ...
    if (validarCampos()) {
        ...
        $("#tblImpuestos").DataTable().destroy();
        cargarDatos(1, "cuerpoImpuestos");
    }
}
...
function abrirFormulario(opcion, id) {
    ...
    switch (opcion) {
        case "modificar":
            $("#modalFormTittle").text("Modificar Registro / Lista de Precio");
            $("#btnModificar").show();
            ...
            break;
        case "eliminar":
            $("#modalFormTittle").text("Eliminar Registro / Lista de Precio");
            $("#btnBorrar").show();
            ...
            break;
        case "insertar":
            $("#modalFormTittle").text("Agregar un Nuevo Registro / Lista de Precio");
            $("#btnInsertar").show();
            $("[name='camposForm']").prop("disabled", false);
            $("#btnBorrar").hide();
            $("#btnModificar").hide();
