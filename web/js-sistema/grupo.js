...
function abrirFormulario(opcion, id) {
    ...
    switch (opcion) {
        case "modificar":
            $("#modalFormTittle").text("Modificar Registro / Grupo");
            $("#btnModificar").show();
            ...
            break;
        case "eliminar":
            $("#modalFormTittle").text("Eliminar Registro / Grupo");
            $("#btnBorrar").show();
            ...
            break;
        case "insertar":
            $("#modalFormTittle").text("Agregar un Nuevo Registro / Grupo");
            $("#btnInsertar").show();
            $("#txtDescripcion").prop("disabled", false);
            $("#btnBorrar").hide();
            $("#btnModificar").hide();
