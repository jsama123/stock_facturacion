...
function abrirFormulario(opcion, id) {
    ...
    switch (opcion) {
        case "modificar":
            $("#modalFormTittle").text("Modificar Registro / Caja");
            $("#btnModificar").show();
            ...
            break;
        case "eliminar":
            $("#modalFormTittle").text("Eliminar Registro / Caja");
            $("#btnBorrar").show();
            ...
            break;
        case "insertar":
            $("#modalFormTittle").text("Agregar un Nuevo Registro / Caja");
            $("#btnInsertar").show();
            $("#txtDescripcion").prop("disabled", false);
            $("#btnBorrar").hide();
            $("#btnModificar").hide();
