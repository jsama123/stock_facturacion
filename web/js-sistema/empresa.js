...
function accionProceso(opcion) {
    datosJson = {
        "opcion": opcion,
        "ci_ruc_empresa": $("#txtCiRuc").val(),
        "razon_social_empresa": $("#txtRazonSocial").val(),
        "nro_telefono_empresa": $("#txtTelefono").val(),
        "direccion_empresa": $("#txtDireccion").val(),
        "email_empresa": $("#txtEmail").val(),
        "actividad_economica": $("#txtActivEcon").val(),
        "id": $("#txtId").val()
    };
    if (validarCampos()) {
...
function abrirFormulario(opcion, id) {
    ...
    switch (opcion) {
        case "modificar":
            $("#modalFormTittle").text("Modificar Registro / Empresa");
            $("#btnModificar").show();
            ...
            break;
        case "eliminar":
            $("#modalFormTittle").text("Eliminar Registro / Empresa");
            $("#btnBorrar").show();
            ...
            break;
        case "insertar":
            $("#modalFormTittle").text("Agregar un Nuevo Registro / Empresa");
            $("#btnInsertar").show();
            $("[name='camposForm']").prop("disabled", false);
            $("#btnBorrar").hide();
            $("#btnModificar").hide();
