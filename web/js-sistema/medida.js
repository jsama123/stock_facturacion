...
function abrirFormulario(opcion, id) {
    ...
    switch (opcion) {
        case "modificar":
            $("#modalFormTittle").text("Modificar Registro / Medida");
            $("#btnModificar").show();
            ...
            break;
        case "eliminar":
            $("#modalFormTittle").text("Eliminar Registro / Medida");
            $("#btnBorrar").show();
            ...
            break;
        case "insertar":
            $("#modalFormTittle").text("Agregar un Nuevo Registro / Medida");
            $("#btnInsertar").show();
            $("#txtDescripcion").prop("disabled", false);
            $("#btnBorrar").hide();
            $("#btnModificar").hide();
