...
<html>
    ...
    <body>
        <h4>Imprimir Descuento Consolidado de Articulos por Fecha</h4><hr>
        ...
        <script type="text/javascript">
            ...
            function imprimirReporte(){
                window.open("ReporteDescArticuloxFecha.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val(), "_blank");
            ...
            function imprimirReporteExcel(){
                ...
                window.location.href = "ReporteDescArticuloxFechaXLS.jsp?fecha_inicio=" + $("#txtFechaDesde").val()+"&fecha_fin="+$("#txtFechaHasta").val();
            }
        </script>
    </body>
</html>
